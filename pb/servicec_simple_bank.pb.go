...
// 	protoc        v3.12.4
// source: servicec_simple_bank.proto
...
var File_servicec_simple_bank_proto protoreflect.FileDescriptor

var file_servicec_simple_bank_proto_rawDesc = []byte{
	0x0a, 0x1a, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x63, 0x5f, 0x73, 0x69, 0x6d, 0x70, 0x6c,
...
var file_servicec_simple_bank_proto_goTypes = []interface{}{
...
var file_servicec_simple_bank_proto_depIdxs = []int32{
...
func init() { file_servicec_simple_bank_proto_init() }
func file_servicec_simple_bank_proto_init() {
	if File_servicec_simple_bank_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_servicec_simple_bank_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_servicec_simple_bank_proto_goTypes,
		DependencyIndexes: file_servicec_simple_bank_proto_depIdxs,
	}.Build()
	File_servicec_simple_bank_proto = out.File
	file_servicec_simple_bank_proto_rawDesc = nil
	file_servicec_simple_bank_proto_goTypes = nil
	file_servicec_simple_bank_proto_depIdxs = nil
}
